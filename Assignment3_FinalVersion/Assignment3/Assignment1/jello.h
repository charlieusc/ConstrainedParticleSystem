...
struct myChain
{   double dt; // timestep, e.g.. 0.001
    double m[pN]; // mass of each of the control points
    double ks;
    double kd; 
    struct point f[pN]; // pointer to the array of values of the force field
    struct point p[pN]; // position of the 512 control points
    struct point v[pN]; // velocities of the 512 control points
    double r;
};

extern struct myChain testChain;
